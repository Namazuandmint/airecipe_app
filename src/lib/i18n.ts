...
const jaMessages = {
  ...
  'fridge.summary.opened': '使用中',
  'fridge.summary.openedNote': '開封状態は未連携',
...
const enMessages: Record<MessageKey, string> = {
  ...
  'settings.notificationsDescription':
    'Save expiration and low-stock notification preferences.',
  ...
  'fridge.summary.opened': 'In use',
  'fridge.summary.openedNote': 'Opened state is not connected yet',
...
const frMessages: Record<MessageKey, string> = {
  ...
  'settings.notifications': 'Notifications',
  'settings.notificationsDescription':
    'Enregistrez les préférences de péremption et de stock faible.',
  ...
  'fridge.summary.opened': 'En cours',
  'fridge.summary.openedNote': 'État ouvert non connecté',
